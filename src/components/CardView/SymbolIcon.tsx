import type { SymbolInstance } from '@/cards/symbols';
...
export const SymbolIcon = ({ symbol }: { symbol: SymbolInstance }) => {
  switch (symbol.id) {
    case 'WAIT':
      return (
    ...
    case 'WITH_TEXT':
      return (
        <div className="relative">
          <SymbolIcon symbol={symbol.params.inner} />
          <WithTextBadge kind={symbol.params.kind} />
        </div>
      );
    default:
      return null;
